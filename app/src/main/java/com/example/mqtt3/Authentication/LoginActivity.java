...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        client = Stitch.getAppClient("nyobastitch-xzojz");
    ...
    private class getLoginTask extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd = ProgressDialog.show(LoginActivity.this, "", "SMAP is recognizing you...", true, false); // Create and show Progress dialog
        }
        ...
        protected void onPostExecute() {
            if (statusCode == 1) {
                ...
                Toast.makeText(LoginActivity.this, "SMAP welcomes you!", Toast.LENGTH_SHORT).show();
                ...
                Log.e("stitch-auth", "Authentication Failed.");
                pd.dismiss();
                Toast.makeText(LoginActivity.this, "Sorry... Error in recognizing.", Toast.LENGTH_SHORT).show();
